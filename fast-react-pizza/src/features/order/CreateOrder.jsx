    ...
    <div className='px-4 py-6'>
      ...
      <Form method='POST'>
        ...
        <div className='mb-5 flex flex-col gap-2 sm:flex-row sm:items-center'>
          ...
          {formErrors?.phone && (
            <p className='rounded-ms mt-2 bg-red-100 p-2 text-xs text-red-700'>
              {formErrors.phone}
            </p>
          )}
        </div>
        ...
        <div className='relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center'>
          ...
          <div className='grow'>
            ...
            />
            {addressStatus === 'error' && (
              <p className='rounded-ms mt-2 bg-red-100 p-2 text-xs text-red-700'>{errorAddress}</p>
            )}
          </div>
        ...
        <div className='mb-12 flex items-center gap-5'>
          ...
          />
          <label className='medium' htmlFor='priority'>
